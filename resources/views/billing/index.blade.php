    ...
    <div class="row g-1">
      ...
      <div class="col-lg-5">
        <div class="search-card">
          ...
          <div id="product_info" class="alert mb-0" style="display:none;">
            <strong id="p_name"></strong> | Price: â‚¹<span id="p_price"></span> | GST: <span id="p_gst"></span>% | Stock: <span id="p_stock"></span> <span id="stock_badge"></span>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-7">
        <div class="manual-card">
          <div class="section-badge">ðŸ“¦ Add Manually</div>
